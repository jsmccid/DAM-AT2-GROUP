...
control_lin <- trainControl(method = "adaptive_cv",
  ...
  save(nn_mod_b, file = "./models/nnetv1.Rdata")
```
...
better_test <- readRDS("./better_test.rds")
...
better_test_pre <- preProcess(better_test, method = "medianImpute")
better_test <- predict(better_test_pre, newdata = better_test)
...
better_test$rating <- predict(nn_mod_b, better_test_1h)
...
# str(preds)
write_csv(preds, "./predictions/nn_predictionsv1.csv")
