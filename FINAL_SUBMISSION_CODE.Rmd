...
svdf_rec3 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=5, gamma = 0.03, lambda = 0.001, min_epochs = 50, max_epochs = 100, min_improvement = 1e-07, verbose = TRUE))
svdf_rec4 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=10, gamma = 0.03, lambda = 0.001, min_epochs = 50, max_epochs = 100, min_improvement = 1e-07, verbose = TRUE))
svdf_rec5 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=15, gamma = 0.03, lambda = 0.001, min_epochs = 50, max_epochs = 100, min_improvement = 1e-07, verbose = TRUE))
svdf_rec6 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=20, gamma = 0.03, lambda = 0.001, min_epochs = 50, max_epochs = 100, min_improvement = 1e-07, verbose = TRUE))
svdf_rec7 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=5, gamma = 0.04, lambda = 0.001, min_epochs = 50, max_epochs = 400, min_improvement = 1e-07, verbose = TRUE))
svdf_rec8 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=10, gamma = 0.04, lambda = 0.001, min_epochs = 50, max_epochs = 400, min_improvement = 1e-07, verbose = TRUE))
svdf_rec9 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=15, gamma = 0.04, lambda = 0.001, min_epochs = 50, max_epochs = 400, min_improvement = 1e-07, verbose = TRUE))
svdf_rec10 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=20, gamma = 0.04, lambda = 0.001, min_epochs = 50, max_epochs = 400, min_improvement = 1e-07, verbose = TRUE))
svdf_rec11 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=7, gamma = 0.05, lambda = 0.001, min_epochs = 50, max_epochs = 150, min_improvement = 1e-07, verbose = TRUE))
svdf_rec12 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=7, gamma = 0.05, lambda = 0.001, min_epochs = 50, max_epochs = 150, min_improvement = 1e-07, verbose = TRUE))
svdf_rec13 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=15, gamma = 0.05, lambda = 0.001, min_epochs = 50, max_epochs = 150, min_improvement = 1e-07, verbose = TRUE))
svdf_rec14 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=7, gamma = 0.05, lambda = 0.001, min_epochs = 50, max_epochs = 250, min_improvement = 1e-07, verbose = TRUE))
svdf_rec15 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=7, gamma = 0.015, lambda = 0.001, min_epochs = 50, max_epochs = 250, min_improvement = 1e-07, verbose = TRUE))
svdf_rec16 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=15, gamma = 0.015, lambda = 0.001, min_epochs = 50, max_epochs = 250, min_improvement = 1e-07, verbose = TRUE))
svdf_rec17 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=15, gamma = 0.015, lambda = 0.001, min_epochs = 50, max_epochs = 250, min_improvement = 1e-07, verbose = TRUE))
svdf_rec18 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=7, gamma = 0.03, lambda = 0.001, min_epochs = 50, max_epochs = 250, min_improvement = 1e-07, verbose = TRUE))
svdf_rec19 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=8, gamma = 0.015, lambda = 0.001, min_epochs = 50, max_epochs = 50, min_improvement = 1e-07, verbose = TRUE))
svdf_rec20 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=8, gamma = 0.015, lambda = 0.001, min_epochs = 50, max_epochs = 1000, min_improvement = 1e-07, verbose = TRUE))

# svdf_rec18 <- Recommender(getData(svde, "train"), method = "SVDF", param=list(k=7, gamma = 0.03, lambda = 0.001, min_epochs = 50, max_epochs = 250, min_improvement = 1e-07, verbose = TRUE)) #9.30
...
test_rat_svdf[test_rat_svdf$rating < 1, "rating"] <- 1 
